...
const initialJobs: Job[] = [
  { id: "JOB-001", title: "Senior Frontend Engineer", dept: "Product Engineering", manager: "Marcus Chen", location: "Remote (GMT+2)", applicants: 142, delta: "+12", status: "Active", skills: ["React", "TypeScript", "Tailwind CSS", "Next.js", "Testing Library"], experience: "Senior / Lead", cultureFit: "High (Innovation focus)", description: "The ideal candidate has 5+ years of experience in high-growth SaaS environments. They excel at architecture and modular component design." },
  { id: "JOB-002", title: "Fullstack Developer (Node.js)", dept: "Core Services", manager: "Sarah Jenkins", location: "Kigali, Rwanda", applicants: 89, delta: "+5", status: "Active", skills: ["Node.js", "PostgreSQL", "REST APIs", "Docker"], experience: "Mid / Senior", cultureFit: "High (Collaboration focus)", description: "Looking for a fullstack developer comfortable with both frontend and backend systems in a fast-paced environment." },
  { id: "JOB-003", title: "Product Designer", dept: "UX/UI Team", manager: "David Miller", location: "Remote (US)", applicants: 56, delta: "-2", status: "Draft", skills: ["Figma", "User Research", "Prototyping", "Design Systems"], experience: "Mid-level", cultureFit: "Medium (Creative focus)", description: "Seeking a product designer who can translate complex user needs into elegant, accessible interfaces." },
  { id: "JOB-004", title: "QA Automation Lead", dept: "Quality Assurance", manager: "Aisha Varma", location: "Hybrid (Nairobi)", applicants: 210, delta: "+45", status: "Active", skills: ["Selenium", "Cypress", "Jest", "CI/CD", "Python"], experience: "Senior / Lead", cultureFit: "High (Quality focus)", description: "Lead our QA automation efforts and build robust testing pipelines across web and mobile platforms." },
  { id: "JOB-005", title: "DevOps Architect", dept: "Infrastructure", manager: "Robert Fox", location: "Remote", applicants: 34, delta: "+1", status: "Closed", skills: ["AWS", "Terraform", "Kubernetes", "CI/CD"], experience: "Principal / Architect", cultureFit: "High (Reliability focus)", description: "Design and maintain scalable cloud infrastructure with a focus on reliability and cost efficiency." },
  { id: "JOB-006", title: "Data Scientist", dept: "Analytics", manager: "Priya Nair", location: "Remote (EU)", applicants: 78, delta: "+8", status: "Active", skills: ["Python", "ML", "SQL", "TensorFlow"], experience: "Mid / Senior", cultureFit: "High (Data-driven)", description: "Build and deploy machine learning models to drive product and business decisions." },
  { id: "JOB-007", title: "Backend Engineer (Go)", dept: "Platform", manager: "James Osei", location: "Hybrid (Lagos)", applicants: 45, delta: "+3", status: "Draft", skills: ["Go", "gRPC", "PostgreSQL", "Redis"], experience: "Mid-level", cultureFit: "Medium (Performance focus)", description: "Join the platform team to build high-throughput backend services in Go." },
];
