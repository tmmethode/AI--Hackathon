...
export const GEMINI_HIRING_SYSTEM_INSTRUCTION_OLD = `
...
export const GEMINI_BATCH_SCREENING_SYSTEM_INSTRUCTION_OLD = `
${GEMINI_HIRING_SYSTEM_INSTRUCTION_OLD}
...
export function buildCandidateScreeningPromptOld(request: GeminiCandidateScreenRequest): string {
...
export function buildBatchScreeningPromptOld(request: GeminiBatchScreeningRequest): string {
